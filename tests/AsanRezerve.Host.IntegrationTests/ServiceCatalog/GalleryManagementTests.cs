...
using AsanRezerve.ServiceCatalog.IntegrationTests.Infrastructure;
...
namespace AsanRezerve.ServiceCatalog.IntegrationTests;
...
{
    public GalleryManagementTests(AsanRezerveHostFactory factory)
        : base(factory)
    {
    }
